...
public:
  ...
  bool begin(I2CArduinoCompat &i2c, bool autoCalibrate = false, bool measBegin = true); // By default use Wire port
  ...
  bool dataAvailable();
  bool readMeasurement(bool skipDataReadyCheck = false);
...
private:
  ...
  I2CArduinoCompat *_i2cPort; // The generic connection to user's chosen I2C hardware
#endif
  // Global main datums
  float co2 = 0;
  float temperature = 0;
